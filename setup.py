...
setuptools.setup(
  ...
  url = 'https://github.com/cryptostockticker/OctopusAgile',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/cryptostockticker/OctopusAgile/archive/v0.0.7.tar.gz',    # I explain this later on
